$(document).ready(function(){
  draw_heatmap("../result/dc_round_trips.tsv", "#dccommuter");
  draw_heatmap("../result/dc_one_way.tsv", "#dcleisure");
  draw_heatmap("../result/nyc_one_way.tsv", "#nyccommuter");
  draw_heatmap("../result/nyc_round_trips.tsv", "#nycleisure");
});
